...
public class AliBaba extends Game {
    ...
    public void create() {
        ...
        java.util.List<Character> characters;
        java.util.List<Weapon> allWeapons;
        java.util.List<Armor> allArmor;
    ...
    public static java.util.List<Character> loadCharactersFromJsonFile(String filePath) throws IOException {
        ...
        // Manually call initializeDerivedCombatStates for each character after deserialization
