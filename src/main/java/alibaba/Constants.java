...
public interface Constants {
    ...
    public enum Map {
        ...
        public void init() {
            ...
            TiledMapTileLayer creatureLayer = (TiledMapTileLayer) this.tiledMap.getLayers().get("creature");
            MapLayer peopleLayer = this.tiledMap.getLayers().get("people");

            Iterator<MapObject> piter = peopleLayer.getObjects().iterator();
            while (piter.hasNext()) {
                MapObject obj = piter.next();
                ...
                TiledMapTileLayer.Cell cell = creatureLayer.getCell(sx, sy);
